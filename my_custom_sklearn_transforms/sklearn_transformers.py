...
class DropColumns(BaseEstimator, TransformerMixin):
    ...
    def norm(self, X):
        ...
        transformer = Normalizer().fit_transform(X.iloc[:,1:13]) 
        transformer
    ...
    def transform(self, X, ChangeValues()):
